(function (document, window, jQuery) {
  class TablePagination {
    ...
    useMobile(paginationId) {
      ...
      media.onchange = () => {
        this.pageLimit = media.matches ? 5 : 10;
        jQuery(document).trigger('paylixTablePaginationUpdateEvent', {
          paginationId,
    ...
    prevPage(paginationId) {
      ...
      jQuery(document).trigger('paylixTablePaginationUpdateEvent', { paginationId });
    }
  ...
  window.paylixTablePagination = TablePagination;
