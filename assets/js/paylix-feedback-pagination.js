(function (document, window, jQuery) {
  class FeedbackPagination {
    ...
    useMobile(paginationId) {
      ...
      media.onchange = () => {
        this.pageLimit = media.matches ? 5 : 10;
        jQuery(document).trigger('paylixFeedbackPaginationUpdateEvent', {
          paginationId,
    ...
    prevPage(paginationId) {
      ...
      jQuery(document).trigger('paylixFeedbackPaginationUpdateEvent', { paginationId });
    }
  ...
  window.paylixFeedbackPagination = FeedbackPagination;
