(function (document, window, jQuery, paylixHelper) {
  class BundleComponent {
    ...
    addAllProducts() {
      ...
      const productsToAdd = productsLeft
        .map((product) => {
          ...
          const valid = paylixHelper.isValidCount({ ...product, count: parseInt(quantity) + 1 });
    ...
    render() {
      ...
      const $products = this.$bundle.find('.paylix-bundle-product');
  ...
  window.paylixBundleComponent = BundleComponent;
})(document, window, jQuery, paylixHelper);
